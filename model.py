...
#################################################
# file to edit: dev_nb/Copy_of_prepros (1).ipynb
###
# The Transformer being used is obtained from Annotaded Transformer
# from Havard NLP https://nlp.seas.harvard.edu/2018/04/03/attention.html
###
import numpy as np
import pandas as pd
import unicodedata
...
def translate(text,model,src,trg):
    ...
    src_mask = (word_tensor != src.word2index["<blank>"]).unsqueeze(-2)
